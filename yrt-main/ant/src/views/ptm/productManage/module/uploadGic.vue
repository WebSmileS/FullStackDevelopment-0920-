        ...
        <div class="">
            <ul>
                <li class="item">
                    ...
                    <a-date-picker
                        :defaultPickerValue="uploadData.begin_date"
                        :value="uploadData.begin_date"
                        @change="changeBegin"
                        placeholder=""
                        format="YYYY-MM-DD"
                        style="width: 80%"
                ...
                <li class="item">
                    ...
                    <a-date-picker
                        :defaultPickerValue="uploadData.end_date"
                    ...
                    <div class="add-box">
                        <div class="up-box">
                            <a-upload
                                ...
                                @change="upCertImg"
                            >
                                <div class="upload-box" v-if="uploadData.url === '' || !uploadData.url">
                                    <a-icon type="plus" />
...
export default {
    ...
    methods: {
        ...
        changeBegin(value, dateString) {
            this.uploadData.begin_date = value;
            this.upLoadPm.begin_date = dateString;
        },
        changeEnd(value, dateString) {
            this.uploadData.end_date = value;
            this.upLoadPm.end_date = dateString;
        },
        ...
        async upCertImg(info) {
            ...
            if (info.file.status === 'done') {
                ...
                if (res.Code || res.code === 0) {
                    let url = this.$Utils.getPictureSrc(res.data.key);
                    this.uploadData.url = url;
                    this.upLoadPm.url = url;
                } else {
                    this.$message.error(res.msg);
                }
            }
        ...
        returnPageData() {
            this.$emit('getData', this.upLoadPm);
        },
