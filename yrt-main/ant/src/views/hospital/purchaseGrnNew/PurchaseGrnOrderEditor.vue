<template>
    <a-row class="pgoe">
        <a-row>
            <div class="editor-form-header-wrapper" style="margin: 1em 0">
                <div class="editor-form-header-item">
                    ...
                    >
                        <a-select-option v-for="d in tableData" :key="d.key">
                            {{ d.org_name }}
                        </a-select-option>
            ...
            <div class="editor-form-footer-full-wrapper" style="margin: 1em 0">
                <template v-if="isReadonly">
                    <span class="label">备注：</span>
                    <span class="content">{{ dataEditing.description }}</span>
                </template>
                <template v-else>
                    <a-input size="small" placeholder="备注" v-model="dataEditing.description"></a-input>
                </template>
            </div>
        ...
        <a-row style="margin-top: 20px">
            ...
            <a-button
                ...
                >生成红冲</a-button
            >
            <a-button type="default" @click="handleClose" style="float: right; margin-left: 8px">取消</a-button>
        </a-row>
    </a-row>
</template>
    ...
    methods: {
        ...
        changeApplyOrg(value) {
            if (value === 'search-more') {
                ...
                this.dataEditing.organizationInnerSn = this.selectedOrg.org_id;
                this.dataEditing.billsType = this.selectedOrg.billsType;
