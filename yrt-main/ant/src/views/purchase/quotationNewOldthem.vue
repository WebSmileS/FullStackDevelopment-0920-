<template>
    <div class="scoped scoped-white">
        <div class="modal-form-input-scoped global-drag create-inquiry-md">
        ...
        <!--头部区域开始-->
        <div class="search-form-wrap" style="margin-top: 72px">
...
import createInquiry from '@/views/commonPage/buyManage/module/createInquiry';
import editInquiry from '@/views/commonPage/buyManage/module/editInquiry';
import replyInquiry from '@/views/commonPage/buyManage/module/replyInquiry';
import price from '@/views/commonPage/buyManage/module/priceInquiry';
