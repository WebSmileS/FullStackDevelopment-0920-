<template>
    <div class="scoped mylic-manage-container">
                ...
                <a-col :span="12">
                    ...
                    <ul class="btn-list-wrap">
                        <li>
                            <a-button
                                :disabled="
                                    downTabsActiveKey !== '1' && downTabsActiveKey !== '2' && downTabsActiveKey !== '3'
                                "
                                @click="openEntry()"
                                type="primary"
                                size="small"
                            ...
                            <!-- <a-button
                                ...
                                type="primary"
                                size="small"
                                :disabled="downTabsActiveKey !== '1' && downTabsActiveKey !== '2' && downTabsActiveKey !== '3'"
                            >
                                录入
                            </a-button>
                            <a-button
        ...
        >
            ...
            <!-- :hideBeginDate="downTabsActiveKey === '2'" 医疗器械经营许可证的上传图片只需要截至时间 -->
            <upload-gic
                ref="upGicPage"
                ...
                :hideBeginDate="downTabsActiveKey === '2'"
...
export default {
    ...
    methods: {
            ...
            await platformAgenecyBaseInfoAPI(sysType, id).then((res) => {
                if (parseFloat(res.code) === 0) {
                    ...
                    if (info.certification_status === 1 || info.certification_status === 2) {
                        // 机构认证状态(audit_status): 0-未认证 1-用户申请认证 2-认证通过 3-认证未通过
        ...
        changeDownTabsFn(activeKey) {
            ...
            if (
                parseInt(this.downTabsActiveKey) === 1 ||
                parseInt(this.downTabsActiveKey) === 2 ||
                parseInt(this.downTabsActiveKey) === 3 ||
                parseInt(this.downTabsActiveKey) === 4
            ) {
            ...
            if (this.downTabsActiveKey === '0') {
                ...
                switch (this.downTabsActiveKey) {
                    case '1': // 营业执照
                        ...
                        break;
                    case '2': // 医疗器械经营许可证
                        platformAgencyDealerAPI(this.oid).then((res) => {
                            this.setUploadDateInfo(res);
                        });
                        break;
                }
        ...
        async uploadGicFn() {
            ...
            const Tab2 = this.downTabsActiveKey === '2'; // 医疗器械经营许可证不需要校验
            if (!Tab2 && (begin || end) && !moment(begin).isBefore(end)) {
                ...
                if (parseFloat(res.code) === 0) {
                    ...
                    switch (this.downTabsActiveKey) {
                        case '1': // 营业执照
                            ...
                            break;
                        case '2': // 医疗器械经营许可证
                            platformAgencyEditDealerAPI(this.oid, {
                                begin_date: params.begin_date,
                                end_date: params.end_date
                            });
                            break;
