                ...
                if (checkRes.editInfoFlag) {
                    ...
                    if (this.entryFormInfo.new) {
                        switch (this.downTabsActiveKey) {
                            case '2':
                                if (sysType === 2) {
                                    this.platformAgencyAddDealerAPIFn(this.oid, checkRes.newObj);
                                } else if (sysType === 3) {
                                    this.platformAgencyAddVendorAPIFn(this.oid, checkRes.newObj);
                                }
                                break;
                            case '3':
                                if (sysType === 2) {
                                    this.platformAgencyAddDealerSecAPIFn(this.oid, checkRes.newObj);
                                }
                                break;
                        }
                    } else {
                        switch (this.downTabsActiveKey) {
                            case '2':
                                if (sysType === 2) {
                                    this.platformAgencyEditDealerAPIFn(this.oid, checkRes.newObj);
                                } else if (sysType === 3) {
                                    this.platformAgencyEditVendorAPIFn(this.oid, checkRes.newObj);
                                }
                                break;
                            case '3':
                                if (sysType === 2) {
                                    this.platformAgencyEditDealerSecAPIFn(this.oid, checkRes.newObj);
                                }
                                break;
                        }
                    }
