        ...
        <div v-show="entireViewShow">
            ...
            >
                <div ref="container" class="order-for-print-order">
                    <div>
                        <slot name="header" :records="records" :page="1" :pageTotal="1"></slot>
                    </div>
                    <div>
                        <slot name="table" :records="records" :page="1" :pageTotal="1"></slot>
                    </div>
                    <div>
                        <slot name="footer" :records="records" :page="1" :pageTotal="1"></slot>
                    </div>
                </div>
            </div>
        </div>
    ...
    methods: {
        ...
        handleSplitPage() {
            ...
            this.splitPageTimer = setTimeout(async () => {
                ...
                const pagesData = splitPageWithIndex(indexArray, this.records);
