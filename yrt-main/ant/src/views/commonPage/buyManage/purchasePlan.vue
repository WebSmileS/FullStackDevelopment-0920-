        ...
        <a-row class="shop-card">
            ...
            <a-row class="shop-card-content">
                ...
                >
                    ...
                    <vxe-table-column field="product_name" title="产品">
                        <template v-slot="{ row }">
                            <a-select
                                mode="default"
                                show-search
                    ...
                    <template v-slot:empty style="height: 60px">
                ...
                <a-row>
                    <a-input v-model="planModalForm.description" placeholder="摘要" class="input" />
                </a-row>
                <a-row>
                    <div class="even-columns group">
                        <div class="col">
    ...
    methods: {
        ...
        getProReturn(dea, ven) {
            ...
            let pmGroup = this.planModalDatas.map((v) => {
                if (v.key === this.selectedVen.key) {
                    return {
                        ...dea,
                        search_product_name: dea.product_name
                    };
                } else {
                    return v;
                }
