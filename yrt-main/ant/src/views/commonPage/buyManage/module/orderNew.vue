    ...
    <div class="scoped scoped-white">
        <div style="height: 21px">
            <a-breadcrumb style="float: left">
                <a-breadcrumb-item style="color: #1890ff">订单</a-breadcrumb-item>
        ...
        <a-row class="shop-card">
            <a-row class="shop-card-header">
                <div class="even-columns group">
                    <div class="col">
                        <div class="col-label">
                            <label class="form-label"><em class="em red">*</em>&nbsp;供货单位</label>
                        </div>
                        <div class="col-input">
                            <a-select
                                mode="default"
                    ...
                    <div class="col" v-if="myOrderPropObj.pageType === 0">
                        <div class="col-label">
                            <label class="form-label"><em class="em red">*</em>&nbsp;采购员</label>
                        </div>
                        <div class="col-input">
                            <a-tree-select
                ...
                <div class="even-columns group">
                    <div class="col" v-if="myOrderPropObj.pageType === 0">
                        <div class="col-label">
                            <label class="form-label"><em class="em red">*</em>&nbsp;采购部门</label>
                        </div>
                        <div class="col-input">
                            <a-tree-select
                                treeNodeFilterProp="title"
                    ...
                    <div class="col">
                        <div class="col-label">
                            <label class="form-label"><em class="em red">*</em>&nbsp;仓库</label>
                        </div>
                        <div class="col-input">
                            <a-tree-select
                                treeNodeFilterProp="title"
            ...
            <a-row class="shop-card-content">
                ...
                >
                    ...
                    >
                        ...
                        <vxe-table-column field="product_name" title="产品" width="144px">
                            <template v-slot="{ row }">
                                <a-select
                                    ...
                                    :default-active-first-option="false"
                                    :data_row="row.key"
                                    @search="orderVendorListAPIFn"
                                    @change="changeApplyVen"
                                >
                                    <a-spin v-if="venFetching" slot="notFoundContent" size="small" />
                                    <a-select-option
                                        v-for="d in venTableData"
                                        :key="d.key"
                                        :value="d.key"
                                        :data_row="row.key"
                                    >
                                    ...
                                    <a-select-option value="search-more" :data_row="row.key">
                                        <b style="color: #1890ff">搜索更多...</b>
                                    </a-select-option>
                                    <a-select-option value="tips">
                                        <i>提示：输入文字搜索</i>
                        ...
                        <vxe-table-column field="action" title="操作" width="90" :resizable="false" fixed="right">
                            <template v-slot="{ row, seq }">
            ...
            <a-row>
                <div class="even-columns group">
                    <div class="col">
                        <span class="label" style="width: 100px; padding-right: 10px">送货地址</span>
                        <a-input
                    ...
                    <div class="col">
                        <span class="label" style="width: 100px; padding-right: 10px">摘要</span>
                        <a-input
                            :disabled="isEditDisabled"
...
export default {
    ...
    props: {
        myOrderPropObj: {
            pageType: 0 // 页面类型判断依据： 0-采购订单  1-销售订单
        }
    },
    components: {
        chooseOrgTab,
    ...
    methods: {
        ...
        async getProReturn(dea, ven) {
            ...
            for (let i = 0; i < this.planModalDatas.length; i++) {
                let item = this.planModalDatas[i];
                if (item.hasOwnProperty('unitPriceList') && item.unitPriceList.length <= 0) {
                    // 是草稿和正式
                    this.contractGetOrderPriceAPIFn(item);
                }
            }
        ...
        changeApplyVen(value, options) {
            if (value === 'search-more') {
                ...
                let pmGroup = this.planModalDatas.map((v) => {
                    if (v.key === pmKey) {
                        return {
                            ...this.selectedVen,
                            key: pmKey,
