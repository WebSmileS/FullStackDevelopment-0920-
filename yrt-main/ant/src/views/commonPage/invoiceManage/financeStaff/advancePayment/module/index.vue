<template>
    <div class="scoped scoped-white">
                ...
                <a-col :sm="22" :md="22" :lg="18" :xl="18" :xxl="15">
                    <ul class="btn-list-wrap">
                        <li>
                            <!-- 只有待审核选项卡的发票才可以审核 -->
                            <a-button
                                :disabled="tabsActiveKey !== tabPane(0, 'value')"
                                type="primary"
                                size="small"
                            ...
                            <a-button
                                :disabled="
                                    !(tabsActiveKey === tabPane(0, 'value') || tabsActiveKey === tabPane(1, 'value'))
                                "
                                type="danger"
                                size="small"
                        ...
                        <li>
                            ...
                            <a-button type="primary" size="small" @click="financeAdvanceExportAPIFn">
                                导出Excel
                            </a-button>
                        </li>
                    </ul>
        ...
        <!-- 相关机构区域 -->
        <choose-org-tab ref="organization" :isInbound="true" @getOrgData="getOrgDataFn"></choose-org-tab>
    </div>
</template>
...
import { financeAdvanceExportAPI } from '@/service/pageAjax';

import moment from 'moment';

export default {
    name: 'advancePaymentFinance-index', // 预付款 = 财务人员使用
    components: {
        tableList,
        tableDetail,
        chooseOrgTab
    ...
    methods: {
        async financeAdvanceExportAPIFn() {
            if (this.exporting) {
                return;
            }
            this.exporting = true;
            ...
            try {
                ...
                const { data, headers } = await financeAdvanceExportAPI(params);
