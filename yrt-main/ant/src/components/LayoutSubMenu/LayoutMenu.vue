<template>
    <a-layout-sider
        ...
        :class="{ 'slider-menu-skeleton': loadingSkeletonShow, 'and-dark' : theme ==='dark', 'and-light' : theme ==='light' }"
        :trigger="null"
        collapsible
        v-model="collapsed"
        theme="light"
    ...
    >
        ...
        <div class="sider-pic">
            <h1 class="logo">
                <img
                    src="/images/logo/YRT-LOGO.svg"
                    alt=""
                    class="logo-right"
                    :style="{ 'height': collapsed ? '15px' : '40px' }"
                />
            </h1>
...
.layout-menu-left-wrap .ant-menu-inline, .layout-menu-left-wrap .ant-menu-vertical, .layout-menu-left-wrap .ant-menu-inline, .layout-menu-left-wrap .ant-menu-vertical-left {
    border-right: none;
    background: #1a1a2d;
}

.layout-menu-left-wrap .ant-menu-inline .ant-menu-item {
    padding-right: 34px;
    color: #9899ac;
}
...
.and-light {
    &.layout-menu-left-wrap {
        ...
        .ant-menu-inline, .ant-menu-vertical, .ant-menu-inline, .ant-menu-vertical-left {
            background: #fff !important;
        }
        .ant-layout-sider-children {
            background: #fff !important;
