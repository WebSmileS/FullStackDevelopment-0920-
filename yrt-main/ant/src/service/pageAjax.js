...
// get Settings
export const userPageSettings = (name, type) => axios.get(`/v1/usersettings/get_user_settings/${name}/${type}`)
// store Settings
export const storePageSettings = params => axios.post(`/v1/usersettings/store_user_settings`, params)
// 登录成功后获取【用户菜单】
...
// 采购入库单可用的产品查询接口
export const purchaseGrnOrderProductListAPI = (pageNum, pageSize, data) => axios.post('/v1/business/grn/product/list', data, { params: { pageNum, pageSize } })
// 采购入库单可用产品扫码查询
...
// 产品列表
export const arrivalOrderProductListAPI = (pageNum, pageSize, data) => axios.post(`${arrivalPath}product/list`, data, { params: { pageNum, pageSize } })
/**
 * 产品列表-扫码
...
// 产品列表
export const inspectionOrderProductListAPI = (pageNum, pageSize, data) => axios.post(`${inspectionOrderPath}product/list`, data, { params: { pageNum, pageSize } })
/**
 * 产品列表-扫码
 * @param {object} searchParams
 * @param {string} searchParams.barcode 条码
