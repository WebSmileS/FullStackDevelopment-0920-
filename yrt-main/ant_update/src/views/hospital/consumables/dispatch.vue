                    ...
                    <ul class="form">
                        ...
                        <li>
                            ...
                            <a-tree-select
                                ...
                                allowClear
                                :value="String(searchTables.department_inner_sn)"
                                @change="(value) => (searchTables.department_inner_sn = value)"
                                class="input"
                            >
                            </a-tree-select>
                        </li>
                                        ...
                                        <ul class="form">
                                            <li style="width: 20%">
                                                ...
                                                <a-tree-select
                                                    ...
                                                    :dropdownStyle="{ maxHeight: '400px', overflow: 'auto' }"
                                                    treeDefaultExpandAll
                                                    :value="String(searchBotTables.warehouse_inner_sn)"
                                                    @change="(value) => (searchBotTables.warehouse_inner_sn = value)"
                                ...
                                >
                                    ...
                                    >
                                        <template v-slot="{ row }">
                                            ...
                                            >
                                                <li>
                                                    <a-tooltip class="tooltip" placement="top" title="申领终止">
                    ...
                    <li :style="btnName !== 'add' ? 'justify-content:space-between' : 'justify-content:start'">
                        ...
                        <div class="item">
                            ...
                            <a-tree-select
                                ...
                                :dropdownStyle="{ maxHeight: '400px', overflow: 'auto' }"
                                treeDefaultExpandAll
                                :value="String(editInfoFormObj.department_name)"
                                @change="(value) => (editInfoFormObj.department_name = value)"
                                :allowClear="false"
                                class="input"
                    ...
                    <li>
                        ...
                        <div class="item">
                            ...
                            <a-tree-select
                                ...
                                :dropdownStyle="{ maxHeight: '400px', overflow: 'auto' }"
                                treeDefaultExpandAll
                                :value="String(applySendInfoFormObj.department_name)"
                                @change="(value) => (applySendInfoFormObj.department_name = value)"
                                :allowClear="false"
                                class="input"
                                style="min-width: 150px"
                            >
