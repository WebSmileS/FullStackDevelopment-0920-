<template>
    <div class="upload-count">
        <div class="">
            <ul>
                <li class="item" v-if="!hideBeginDate">
...
export default {
    name: 'uploadGic',
    props: ['chooseTrObj', 'upLoadStatus', 'tabsKey', 'downTabsKey', 'uploadDateInfo', 'hideBeginDate'],
    components: {
        PictureBox
    },
    data() {
        ...
        async upCertImg(info) {
            ...
            if (info.file.status === 'done') {
                ...
                if (res.code === 0) {
                    ...
                    // this.uploadData.begin_date = this.begin_date
                    // this.uploadData.end_date = this.end_date
                    // this.returnPageData()
                } else {
                    this.$message.error(res.msg);
                }
