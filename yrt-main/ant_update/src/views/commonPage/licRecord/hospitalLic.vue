    ...
    <div class="scoped agency-approval-container">
        ...
        <div class="tab-table-wrap tab-table-overflowy">
            ...
            <a-tabs @change="changeTabsFn" type="card">
                <a-tab-pane v-for="tabItem in agencyTab" :tab="tabItem.key" forceRender :key="tabItem.systemTypes">
                    <div class="box">
                        <div class="boxtop">
                            <vxe-table
                                ref="xTable"
...
export default {
    ...
    data() {
        return {
            ...
            agencyTab: TabTypeCfg.licHospitalTabSet(),
            tableSet: TabTypeCfg.licHospitalTableTAb(),
    ...
    methods: {
        ...
        // 根据注册机构类型【获取机构列表】
        async licManageHospitalFn(systemType = this.tabsActiveKey) {
            if (this.tabsActiveKey === 'hospital') {
        ...
        changePaginationFn({ currentPage, pageSize }) {
            ...
            this.licManageHospitalFn(this.tabsActiveKey);
        },
        // 表格重新刷新数据的初始化函数 01
        initRfreshTablesFn() {
        ...
        previewImg(src) {
            ...
            if (src && src !== '') {
                ...
                img.onload = function () {
                    ...
                    that.imgPreviewTitle = '医院 - ' + current.tab + ' - 图片预览';
