        ...
        <div class="info-count modal-form-input">
            <ul>
                ...
                <li class="item-agency" v-if="downTabsActiveKey === '2'">
                    ...
                    <a-input v-model="entryFormInfo.registered_number" class="input input-short" />
                </li>
                <li class="item-agency" v-if="downTabsActiveKey === '1'">
                    <div class="item-children item-children-agency-approval">
                        ...
                        <a-input v-model="entryFormInfo.social_credit_code" class="input input-short" />
                    </div>
                ...
                <li class="item-agency" v-if="downTabsActiveKey === '1'">
                    <div class="item-children item-children-agency-approval" style="width: 318px">
                ...
                <li class="item-agency" v-if="downTabsActiveKey === '1' || downTabsActiveKey === '2'">
                    ...
                    <div class="item-children item-children-agency-approval" v-if="downTabsActiveKey === '2'">
                        ...
                        <a-input v-model="entryFormInfo.issue_organization" class="input input-short" />
                    </div>
                    <div class="item-children">
...
export default {
                ...
                if (checkRes.editInfoFlag) {
                    ...
                    if (this.entryFormInfo.new) {
                        switch (this.downTabsActiveKey) {
                            case '1':
                                this.platformAgencyAddLicAPIFn(this.tabsActiveKey, this.oid, checkRes.newObj);
                                break;
                            case '2':
                                this.platformAgencyAddHospitalAPIFn(this.oid, checkRes.newObj);
                                break;
                        }
                    } else {
                        switch (this.downTabsActiveKey) {
                            case '1':
                                this.platformAgencyEditLicAPIFn(this.tabsActiveKey, this.oid, checkRes.newObj);
                                break;
                            case '2':
                                this.platformAgencyEditHospitalAPIFn(this.oid, checkRes.newObj);
                                break;
                        }
                    }
                }
    ...
    mounted() {
        ...
        if (this.downTabsActiveKey === '1') {
            // 营业执照
            this.platformAgencyLicAPIFn(this.tabsActiveKey, this.oid);
        } else if (sysType === 1 && this.downTabsActiveKey === '2') {
            // 医院医疗执业许可证
            this.platformAgencyHospitalAPIFn(this.oid);
        }
    }
};
</script>
