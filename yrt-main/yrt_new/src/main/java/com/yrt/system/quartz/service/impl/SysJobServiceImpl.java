package com.yrt.system.quartz.service.impl;
...
import com.yrt.common.constant.ScheduleConstants;
...
import com.yrt.system.quartz.mapper.SysJobMapper;
import com.yrt.system.quartz.service.ISysJobService;
import com.yrt.system.quartz.util.CronUtils;
import com.yrt.system.quartz.util.ScheduleUtils;
...
//        job.setUpdateBy(ShiroUtils.getLoginName());
    ...
    @Override
    @Transactional
    public int deleteJob(Long jobId) throws SchedulerException
    {
