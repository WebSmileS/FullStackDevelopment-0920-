...
@Data
public class EditOrgDeptForm implements Serializable {
	...
	public boolean hasUpdate() {
		if(StringUtils.isNotNull(parent_department_inner_sn) || StringUtils.isNotNull(parent_department_inner_sn_old)) {
			if(StringUtils.isNull(parent_department_inner_sn) && StringUtils.isNotNull(parent_department_inner_sn_old)) {
				parent_department_inner_sn = -1L;
			}
