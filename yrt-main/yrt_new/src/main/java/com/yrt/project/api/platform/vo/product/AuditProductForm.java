...
@Data
public class AuditProductForm implements Serializable {
	...
	@ApiModelProperty(value="审批状态 0-通过 1-不通过 2-已有相同审核",required=true)
	@NotNull(message = "审批状态不能为空")
	private Integer auditStatus;
	
	@ApiModelProperty(value="审批说明",required=false)
