...
@Data
public class EditSaleRecordForm implements Serializable {
	...
	@ApiModelProperty(value="状态(1-正式 2-已审核)",required=true)
	@NotNull(message = "状态")
	...
	List<EditSaleRecordDetailForm> details = new ArrayList<EditSaleRecordDetailForm>();
}
