...
public class PaymentOrder {
	...
	@Excel(name = "付款状态", readConverterExp = "TO_BE_PAID=待付款,PAID=已付款,RECORDED=已入账", type = Type.EXPORT)
	...
	@Excel(name = "付款人", type = Type.EXPORT)
	private String payment_by;
	@Excel(name = "付款时间", dateFormat = "yyyy-MM-dd")
	@JsonFormat(pattern = "yyyy-MM-dd")
	...
	private List<PaymentOrderDetail> details;
}
