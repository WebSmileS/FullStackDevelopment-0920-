...
/**
    ...
    */
@Data
@TableName(value = "vendor_product_min_unit_inventory")
@Accessors(chain = true)
public class VendorProductMinUnitInventory {
    /**
     * 厂商内部编号
     */
    @TableField(value = "vendor_inner_sn")
    private Integer vendorInnerSn;
    ...
    public static final String COL_VENDOR_INNER_SN = "vendor_inner_sn";
