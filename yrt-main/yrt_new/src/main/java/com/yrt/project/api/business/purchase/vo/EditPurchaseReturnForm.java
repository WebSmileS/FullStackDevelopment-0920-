package com.yrt.project.api.business.purchase.vo;
...
@Data
public class EditPurchaseReturnForm {
	...
	public Map<String,Object> getInfo(){
		...
		if(StringUtils.isNotEmpty(grn_sn) || StringUtils.isNotEmpty(grn_sn_old)) {
			if(StringUtils.isEmpty(grn_sn)) {
				grn_sn = numberUtils.getMaxSn(VoucherType.PURCHASE_RETURN, ServletUtils.getCurUserSystemType(), org_id);//.getPutInMaxSn(ServletUtils.getCurUserSystemType(), org_id);
			}
