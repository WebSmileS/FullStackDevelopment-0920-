...
@Data
public class TmpProductComposeForm implements Serializable {
	...
	@Null(groups= {Add.class}, message = "产品ID必须为空")
	@NotNull(groups= {Update.class},message = "产品ID不能为空")
	...
	@ApiModelProperty(value="规格型号及最小包装单位列表",required=true)
	@NotNull(message = "规格型号及最小包装单位列表不能为空")
	private List<TmpProductSpecComposeForm> specAndMinUnitList;
}
