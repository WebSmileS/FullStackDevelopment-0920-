...
public class OrthopaedicOperationPlanKitProductDetail {
	@ApiModelProperty("工具明细id(新增时不填)")
    private Long id;

	@ApiModelProperty("所属工具包实例id(新增时不填)")
    private Long kit_ins_id;
	...
	@ApiModelProperty("回库数量(回库时填写)")
    private BigDecimal back_quantity;

	@ApiModelProperty("销售数量(确认销售时填写)")
    private BigDecimal sale_quantity;
	
	@ApiModelProperty("报损数量(确认销售时填写): quantity = back_quantity + sale_quantity + loss_quantity")
    private BigDecimal loss_quantity;

	@ApiModelProperty("报损原因(确认销售时填写)")
    ...
    public Long getKit_ins_id() {
        return kit_ins_id;
    }

    public void setKit_ins_id(Long kit_ins_id) {
        this.kit_ins_id = kit_ins_id;
    }
    ...
    public String toString() {
        ...
        sb.append(", kit_ins_id=").append(kit_ins_id);
    ...
    public boolean equals(Object that) {
        ...
        OrthopaedicOperationPlanKitProductDetail other = (OrthopaedicOperationPlanKitProductDetail) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            && (this.getKit_ins_id() == null ? other.getKit_ins_id() == null : this.getKit_ins_id().equals(other.getKit_ins_id()))
            ...
            && (this.getBack_quantity() == null ? other.getBack_quantity() == null : this.getBack_quantity().equals(other.getBack_quantity()))
            && (this.getSale_quantity() == null ? other.getSale_quantity() == null : this.getSale_quantity().equals(other.getSale_quantity()))
            && (this.getLoss_quantity() == null ? other.getLoss_quantity() == null : this.getLoss_quantity().equals(other.getLoss_quantity()))
            && (this.getLoss_reason() == null ? other.getLoss_reason() == null : this.getLoss_reason().equals(other.getLoss_reason()));
    }
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getKit_ins_id() == null) ? 0 : getKit_ins_id().hashCode());
