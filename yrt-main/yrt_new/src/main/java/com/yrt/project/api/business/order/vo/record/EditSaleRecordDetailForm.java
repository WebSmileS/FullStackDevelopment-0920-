...
@Data
public class EditSaleRecordDetailForm implements Serializable {

	private static final long serialVersionUID = 1L;
	
	@ApiModelProperty(value="销售单明细ID",required=true)
	@NotNull(message = "销售单明细ID不能为空")
	...
	@NotNull(message = "修改后数量不能为空")
	private BigDecimal quantity;
	@ApiModelProperty(value="修改前数量,数量无变化时与quantity值一样",required=true)
	@NotNull(message = "修改前数量不能为空")
	...
	/** 编辑动作 0-删除 1-新增 2-修改 */
	@ApiModelProperty(value="编辑动作 0-删除 1-新增 2-修改",required=true)
	@NotNull(message = "操作动作不能为空")
	private Integer action;
	
//	@ApiModelProperty(value="销售单关联单据类型",required = true)
//	private SaleRecordRefType voucher_type;
}
