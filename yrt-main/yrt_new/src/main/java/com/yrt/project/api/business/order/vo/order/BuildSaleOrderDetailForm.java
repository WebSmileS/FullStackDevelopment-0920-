...
@Data
public class BuildSaleOrderDetailForm implements Serializable {
...
//	@JsonFormat(pattern = "yyyy-MM-dd")
//	@ApiModelProperty(value="过期日期",required=false)
//	private Date overdue_date;
	...
	@ApiModelProperty(value="最小单位的待售数量",required=true)
	@NotNull(message = "最小单位的待售数量")
	private BigDecimal min_unit_for_sale_quantity = new BigDecimal(0);
	
	@ApiModelProperty(value="销售单关联单据类型",hidden = true)
	private RefVoucherType voucher_type = RefVoucherType.ORDER_SO;
}
