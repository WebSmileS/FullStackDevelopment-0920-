...
@Data
public class GrantSendDetailForm implements Serializable {

	private static final long serialVersionUID = 1L;
	
	@ApiModelProperty(value="申领单明细ID",required=true)
	@NotNull(message = "申领单明细ID不能为空")
	...
	private String unit;
	@ApiModelProperty(value="批准发放量",required=true)
	@NotNull(message = "批准发放量不能为空")
	private BigDecimal grant_quantity;
	@ApiModelProperty(value="还需发放量",required=true)
	@NotNull(message = "还需发放量不能为空")
	private BigDecimal need_quantity;
	@ApiModelProperty(value="最小单位转换量",required=true)
	@NotNull(message = "最小单位转换量不能为空")
	private BigDecimal min_unit_grant_quantity;
