...
@Data
public class ArrivalRecordForm implements Serializable {
	
	private static final long serialVersionUID = 1L;
	
	@ApiModelProperty(value = "收货单ID,编辑时不能为空")
	private Long id;
	
	@ApiModelProperty(value = "相关机构内部编号", required = true)
	@NotNull(message = "收货单内部编号不能为空")
	...
	@ApiModelProperty(value = "收货单明细", required = true)
	@NotNull(message = "收货单明细不能为空")
	private List<ArrivalRecordDetailForm> details;
}
