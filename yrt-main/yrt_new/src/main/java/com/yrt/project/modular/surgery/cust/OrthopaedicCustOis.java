...
public class OrthopaedicCustOis {
	
	@ApiModelProperty(value = "定制手术包id（is_cust=false时,为空）")
	...
	@ApiModelProperty(value = "源平台手术包inner_sn")
	@NotNull(message="platform_ois_inner_sn不能为空")
    private Long platform_ois_inner_sn;

	@ApiModelProperty(value = "类型inner_sn")
	@NotNull(message="type_inner_sn不能为空")
    private Long type_inner_sn;

	@ApiModelProperty(value = "品牌inner_sn")
	@NotNull(message="brand_inner_sn不能为空")
    private Long brand_inner_sn;

	@ApiModelProperty(value = "状态(总是有效)")
	...
	///////////////////////////////////////////////////////////
	@ApiModelProperty(value = "类型名称。虚拟字段，保存时无意义。")
    @Getter @Setter
    private String type_name;
    
	@ApiModelProperty(value = "品牌名称。虚拟字段，保存时无意义。")
    @Getter @Setter
    ...
    public boolean equals(Object that) {
        ...
        OrthopaedicCustOis other = (OrthopaedicCustOis) that;
