...
public class OrthopaedicCustOisProductDetail {
	@ApiModelProperty(value = "明细id")
	//@NotNull(message="明细id不能为空")
    private Long id;

	@ApiModelProperty(value = "所属手术包id。与手术包一起保存时不需要")
	//@NotNull(message="明细id不能为空")
    private Long ois_id;
	...
	@ApiModelProperty(value = "数量inner_sn")
    ...
    public boolean equals(Object that) {
        ...
        OrthopaedicCustOisProductDetail other = (OrthopaedicCustOisProductDetail) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            && (this.getOis_id() == null ? other.getOis_id() == null : this.getOis_id().equals(other.getOis_id()))
