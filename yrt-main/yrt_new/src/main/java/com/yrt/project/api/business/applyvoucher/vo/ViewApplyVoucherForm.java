...
@Data
public class ViewApplyVoucherForm implements Serializable {
	...
	@ApiModelProperty(value = "申领单明细列表")
	private List<HospitalApplyVoucherDetail> details;
