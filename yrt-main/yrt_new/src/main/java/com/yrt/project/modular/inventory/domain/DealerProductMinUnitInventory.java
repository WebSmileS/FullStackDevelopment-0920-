 ...
 */
@Data
@TableName(value = "dealer_product_min_unit_inventory")
@Accessors(chain = true)
public class DealerProductMinUnitInventory {
    /**
     * 经销商内部编号
     */
    @TableField(value = "dealer_inner_sn")
    private Integer dealerInnerSn;
    ...
    public static final String COL_DEALER_INNER_SN = "dealer_inner_sn";
