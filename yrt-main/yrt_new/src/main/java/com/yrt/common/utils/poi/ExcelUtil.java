...
import com.yrt.common.utils.file.FileTypeUtils;
import com.yrt.common.utils.file.ImageUtils;
import com.yrt.common.utils.reflect.ReflectUtils;
...
import com.yrt.framework.aspectj.lang.annotation.Excels;
    ...
    public List<T> importExcel(String sheetName, InputStream is) throws Exception
    {
        ...
        if (rows > 0)
        {
            ...
            for (int i = 1; i <= rows; i++)
            {
                ...
                {
                    Object val = Utils.trimObject(this.getCellValue(row, entry.getKey()));
                    ...
                    {
                        val = Convert.toBigDecimal(val.toString().trim());
                    }
...
//    }
    ...
    {
        String downloadPath = YrtConfig.getDownloadPath() + filename;
