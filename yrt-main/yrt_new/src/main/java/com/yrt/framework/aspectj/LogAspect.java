...
import com.yrt.common.utils.IpUtils;
import com.yrt.common.utils.ServletUtils;
import com.yrt.common.utils.StringUtils;
import com.yrt.framework.aspectj.lang.annotation.Log;
import com.yrt.framework.aspectj.lang.enums.BusinessStatus;
import com.yrt.framework.async.AsyncManager;
import com.yrt.framework.async.factory.AsyncFactory;
...
public class LogAspect
{
    ...
    // 配置织入点
    @Pointcut("@annotation(com.yrt.framework.aspectj.lang.annotation.Log)")
    ...
    protected void handleLog(final JoinPoint joinPoint, final Exception e)
    {
        try
        {
            ...
            // 获取当前的用户
//            ShiroUser currentUser = ShiroKit.getSysUser();
            ...
            if(curUser != null) {
            	operLog.setOperName(curUser.getEmployee()==null?"":curUser.getEmployee().getName());
            }else {
            	operLog.setOperName("");
            }
