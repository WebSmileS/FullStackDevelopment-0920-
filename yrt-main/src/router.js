        ...
        children: [
            ...
            },
            {
                ...
                children: [
                    ...
                    {
                        // 目前厂商端在使用，经销商和医院端的采购入库已重构为各自的purchaseGrn
                        path: 'buyGrn',
                        name: 'buyGrn',
                    ...
                    },
                    {
                        path: 'reportingLoss',
                        name: 'reportingLoss',
                        component: () => import('@/views/commonPage/warehouseManage/reportingLoss'),
                        meta: {
                            title: '报损',
                            requiresAuth: true
                        }
                    ...
                    {
                        path: 'reportingOverflow',
                        name: 'reportingOverflow',
                        component: () => import('@/views/commonPage/warehouseManage/reportingOverflow'),
                        meta: {
                            title: '报溢',
                            requiresAuth: true
                        }
