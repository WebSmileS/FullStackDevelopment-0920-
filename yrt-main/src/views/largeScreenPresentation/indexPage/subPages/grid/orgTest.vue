    ...
    <div class="common-grid-wrapper">
        ...
        <div class="common-grid-container">
            ...
            <table class="common-grid-table">
                <thead>
                    <tr>
                        <th style="width:450px">企业名称</th>
                        <th style="width:250px">统一信用代码</th>
                        <th style="width:140px">企业法人</th>
                        <th style="width:150px">联系电话</th>
                        <th style="width:400px">地址</th>
                        <th style="width:80px">业务往来机构数量</th>
                        <th style="width:100px">产品往来种类数量</th>
                        <th style="width:240px">最近交易时间</th>
                    </tr>
                </thead>
            </table>
             <vue-seamless-scroll :data="listData" class="warp" ref="seamlessScroll">
                ...
                <li v-for="(item, index) in listData" :key="index">
                    <span style="width:450px" class="name" v-text="item.name"></span>
                    <span style="width:250px" class="social_credit_code" v-text="item.social_credit_code"></span>
                    <span style="width:140px" class="legal_representative" v-text="item.legal_representative"></span>
                    <span style="width:150px" class="phone" v-text="item.phone"></span>
                    <span style="width:400px" class="address" v-text="item.address"></span>
                    <span style="width:100px" class="phone" v-text="item.amount"></span>
                    <span style="width:100px" class="phone" v-text="item.typeAmount"></span>
                    <span style="width:240px" class="time" v-text="item.time"></span>
                </li>
                </ul>
            </vue-seamless-scroll>
    ...
    export default {
        ...
        methods: {
            ...
            async screenTradeItemsAPIFn () {
                this.listData = table.map(m => {
                    return {
                        // 'celName': this.celsNameMock[(Math.random()*10).toFixed(0)],
                        'time': moment().add(-(Math.random()*10).toFixed(0), 'days').format('YYYY-MM-DD h:mm:ss'),
                        'amount': (Math.random()*10).toFixed(0),
                        'typeAmount': (Math.random()*100).toFixed(0),
                        ...m
                    }
                });
                // let params = {
