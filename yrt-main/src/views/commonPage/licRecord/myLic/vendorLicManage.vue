<template>
    <div class="scoped mylic-manage-container">
        ...
        >
            ...
            <!-- :hideBeginDate="downTabsActiveKey === '2'" 医疗器械生产许可证的上传图片只需要截至时间 -->
            <upload-gic
                ref="upGicPage"
...
export default {
    ...
    methods: {
            ...
            if (this.downTabsActiveKey === '0') {
                ...
                switch (this.downTabsActiveKey) {
                    case '1': // 营业执照
                        ...
                        break;
                    case '2': // 医疗器械生产许可证
                        platformAgencyVendorAPI(this.oid).then((res) => {
                            this.setUploadDateInfo(res);
                        });
                        break;
                }
        ...
        async uploadGicFn() {
            ...
            const Tab2 = this.downTabsActiveKey === '2'; // 医疗器械生产许可证不需要校验
                ...
                if (parseFloat(res.code) === 0) {
                    ...
                    switch (this.downTabsActiveKey) {
                        case '1': // 营业执照
                            ...
                            break;
                        case '2': // 医疗器械生产许可证
                            platformAgencyEditVendorAPI(this.oid, {
                                begin_date: params.begin_date,
                                end_date: params.end_date
                            });
                            break;
