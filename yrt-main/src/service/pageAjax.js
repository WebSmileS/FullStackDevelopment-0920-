...
// 库存记录查询
export const searchFinanceStockListAPI = (pageNum, pageSize, orderByColumn, isAsc, params) => axios.post(`/v1/business/finance/inventory/list?pageNum=${pageNum}&pageSize=${pageSize}&isAsc=${isAsc}`, params, { timeout: LongTimeout })
// 仓库人员查询
...
// 财务管理 - 出库查询金额合计
export const getFinanceInventorySumAPI = (params) => axios.post(`/v1/business/finance/inventory/sum/price`, params, { timeout: LongTimeout })
// 全量仓库库存记录查询
